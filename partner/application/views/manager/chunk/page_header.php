                  ...
                  <ul>
                      ...
                      <li>
                        <a href="<?=site_url("event/add")?>"  >
                           <div class="nav-item">
                              <div class="scanicon">
                                 <i class="flaticon-calendar-1"></i> Create Event
                              </div>
                           </div>
                        </a>
                     </li> 
                      <li>
                        <a href="javascript:void(0);" id="scanme">
                           <div class="nav-item">
                              <div class="scanicon">
                                 <img src="assets/images/scan-icon.svg" width="20px" />
                              </div>
                           </div>
                        </a>
                     </li> 
               ...
               <div class="nav-item p-relative">
                  ...
                  <div class="user__dropdown">
                     <ul>
                        ...
                        <li>
                           <a href="<?=site_url('login/logout')?>"><svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
