                        	...
                        	<div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12">
                            	<div class=" ">
                                    <div class="card shadow">
                                      <ul>
                                        <li class="pack"><?=$data['name']?></li>
                                        <li id="basic" class="price bottom-bar"><?=$data['prices']?> Eth</li>
                                        
                                        <li class="bottom-bar"><?=$data['description']?></li>
                                        <li><a href="<?=site_url('services/purchase/'.$data['id'])?>" class="btn">Subscribe</a></li>
                                      </ul>
                                    </div>
                                </div> 
                                <br/> 
