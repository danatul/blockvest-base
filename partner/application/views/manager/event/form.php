                              ...
                              <div class="row g-20">
								 ...
								 /*div class="col-xxl-12 col-xl-12 col-lg-12">
                                    <div class="singel__input-field">
                                        <label class="input__field-text">Price Event(ETH) <?php if(isset($data['txhash'])){ if(!empty($data['txhash'])){ ?> <sup class="alert alert-info">Payment Approve</sup> <?php } }?></label>
                                       <input type="number"   name="price" id="price" min="0" class="form-control required" value="<?=isset($data['price'])?$data['price']:"0"?>" <?php if(isset($data['txhash'])){ if(!empty($data['txhash'])){ ?> readonly="readonly" <?php } }?> required>
                                    </div>
                                 </div>
								 */
								 ?>
		...
		submitHandler:function(){
			...
			setTimeout(function()
			{
				...
				req.done(function(out){
					if(!out.error)
					{
						document.location.href = out.urls;//"<?=site_url("event")?>";
					}
					else
					{
