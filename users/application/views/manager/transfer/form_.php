                ...
                <div class="row justify-content-center mt-0">
                    <div class="col-11 col-sm-9 col-md-7 col-lg-6 text-center p-0 mt-3 mb-2">
                        <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                            <h2><strong><?=custom_language('Transfer Balance')?></strong></h2>
                                ...
                                <div class="col-md-12 mx-0">
                                    <form id="msform">
                                        ...
                                        <ul id="progressbar">
                                            ...
                                            <li id="personal" data-key="1"><strong><?=custom_language('Account')?></strong></li>
                                        ...
                                        <fieldset  class="1  ">
                                            <div class="form-card">
                                                <h2 class="fs-title"><?=custom_language('Akun Identitiy')?></h2>
                                        ...
                                        <fieldset class="2 xhide">
                                            ...
                                            <input type="submit"   class="action-button" style="background:#069;" value="<?=custom_language('Transfer')?>"/> 
                                        </fieldset>
...
$(".next").click(function(){
    ...
    console.log(next_fs);
    //Add Class Active
    var akun_identitys = $("#msform #akun_identity").val();
