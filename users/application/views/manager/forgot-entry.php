           ...
           <div class="content">
              ...
              <form action="javascript:void(0);" role="form" method="post" id="frm-object" class="form-body js-validation-login">
               ...
               <div class="vg form-custom form-label form-border form-icon mb-3 bg-transparent">
                   ...
                   <input type="email" class="form-control rounded-xs" required="required" name="email" id="email" value="<?=$data['email']?>"  placeholder="Email Address"/>
               ...
               <div class="vg form-custom form-label form-border form-icon mb-3 bg-transparent">
                   ...
                   <input type="password" class="form-control rounded-xs" required="required" name="password" id="password" placeholder="Choose Password"/>
               ...
               <div class="vg form-custom form-label form-border form-icon mb-4 bg-transparent">
                   <i class="bi bi-asterisk font-13"></i>
                   <input type="password" class="form-control rounded-xs" equalTo="#password" placeholder="Confirm Password"/>
