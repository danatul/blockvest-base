                                                           ...
                                                           <div class="card-body padding-0 margin-0 card-task">
                                                             ...
                                                             <div class="card-body  card-task" style="min-height:100px;">
                                                               ...
                                                               <?php
																...
																if((strtotime($arr[$i]['end_date'])<time()) && !isset($arr[$i]['user_reward']['id']))
																{
															   ?>
                                                                <span  class="alert alert-danger form-control text-center" style="">Waktu Event Berakhir</span>
															   <?php
																}else
																{
																	if(isset($arr[$i]['user_reward']['id']))
																	{
																		if($arr[$i]['user_reward']['status']==1 || $arr[$i]['user_reward']['status']==2)
																		{
															   ?> 
                                                               <a href="<?=site_url("event/details/".$arr[$i]['id'])?>?type=ongoing" class="btn btn-sm btn-xs btn-lg btn-full" style="background:<?=$bgcolor?>;"><?=$names?></a>
                                                               <?php
																		}else
																		{
																?>
