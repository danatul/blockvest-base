	...
	<div class="content my-0 mt-n2 px-1">
            <div class="d-flex">
                <div class="align-self-center">
                    <h3 class="font-16 mb-2"><?=custom_language('Ticket')?> </h3>
                </div>
                 ...
                 <!-- -->
                  <div class="tabs tabs-pill" id="tab-group-2">
                    <div class="tab-controls rounded-m p-1 overflow-visible">
                         ...
                         <a class="font-13 rounded-m shadow-bg shadow-bg-s tab_upcoming tabsb" data-bs-toggle="collapse" href="#tabtipe_upcoming" aria-expanded="true">Upcoming</a>
                         <a class="font-13 rounded-m shadow-bg tab_ongoing shadow-bg-s tabsb" data-bs-toggle="collapse" href="#tabtipe_ongoing" aria-expanded="false">On Going</a>
                    ...
                    <!-- Tab Group 1 -->
                        ...
                        <div class="collapse tabtipe_upcoming show  coltab" id="tabtipe_upcoming" data-bs-parent="#tab-group-2">
                            <!-- -->
                        ...
                        <!-- Tab Group ongoing -->
                         <div class="collapse tabtipe_ongoing  coltab" id="tabtipe_ongoing" data-bs-parent="#tab-group-2">
                            <!-- -->
 ...
 <script type='text/javascript'>
	$(document).ready(function() {   
 	...
 	function createPagination_upcoming(pageNum){
		$.ajax({
			url: '<?=base_url()?>index.php/event/upcoming/'+pageNum,
			type: 'get',
			dataType: 'json',
	...
	function createPagination_on_going(pageNum){
		$.ajax({
			url: '<?=base_url()?>index.php/event/on_going/'+pageNum,
			type: 'get',
			dataType: 'json',
			success: function(responseData){
	...
	function createPagination_completes(pageNum){
		$.ajax({
			url: '<?=base_url()?>index.php/event/completes/'+pageNum,
			type: 'get',
			dataType: 'json',
			success: function(responseData){
