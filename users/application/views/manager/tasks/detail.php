                                                        ...
                                                        <div class="card  card-style  padding-0 margin-0" style="min-height:150px;">
                                                           <div class="card-body padding-0 margin-0 card-task">
                                                               ...
                                                               <h1 class="text-center h-task">
                                                                ...
                                                                <img src="<?=config_item('main_site')?>uploads/<?=$data['images']?>" alt="img" width="100%" height="370"   class="mx-auto  shadow-l">
                                                             ...
                                                             <div class="card-body  card-task" style="min-height:100px;">
                                                               ...
                                                               <?php
															   	if(isset($data['user_reward']['status']))
																{
																	...
																	if($data['user_reward']['status']==4 || $data['user_reward']['status']==2 || $data['user_reward']['status']==1)
																	{
																		$rr = json_decode($data['user_reward']['prove'],true);
																		if(isset($rr['image']))
																		{
															   ?>
                                                               			<h4>Your Prove 
                                                                        <span style="background:<?=$warna[$data['user_reward']['status']]?>; color:white; border:1px solid #ccc; border-radius:0.5px; padding:4px; font-size:15px; float:right;"><?=rewardstatus($data['user_reward']['status'])?></span>
                                                                        </h4>
                                                              			
                                                                        <ul>
                                                                        	 
                                                                            <li>Note <?=$rr['prove']?></li>
                                                                            <li><img src="<?=config_item('main_site')?>uploads/<?=$rr['image']?>" height="100" /></li>
                                                                            
                                                                        </ul>
                                                                        <?php
																			if($data['user_reward']['status']==2)
																			{
																		?>
                                                                        		<p><b>Reason Rejected</b>: <i><?=$data['user_reward']['reason']?></i></p>
                                                                        <?php
																			}
																		?>
                                                                        <a href="<?=site_url("tasks")?>"   class="btn btn-warning btn-sm btn-xs btn-lg btn-full">Back To Task</a>
                                                               <?php
																		}
																	}else
																	{
																?>
                                                                 <a href="javascript:void(0);" id="start_task" class="btn btn-info btn-sm btn-xs btn-lg btn-full">Start Task</a>
                                                                <?php		
																	}
																}else
																{
                      	...
                      	<div class="col-12" style="min-height:400px;">
                             ...
                             <form action="javascript:void(0);" method="post" id="frm-screenshot">  
                                ...
                                <div class="form-group">
                                   	...
                                   	<div class="form-group">
                                    	<label>Note</label>
                                        <textarea class="form-control" name="prove"></textarea>
                                    </div>                    
                                    <hr/>
                                    <div class="form-group">
