...
function get_itemxml($arr)
{
	if(isset($arr['channel']['item']))
	{
...
{
	$xml = simplexml_load_string($xmlstring, "SimpleXMLElement", LIBXML_NOCDATA | LIBXML_NOBLANKS ); #simplexml_load_string($xmlstring, "SimpleXMLElement", LIBXML_NOCDATA);
