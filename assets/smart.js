...
smart_loader +='                    </svg>';
smart_loader +='<span class="loader-logo"><img class="img-responsive" src="../../presale - Copy/assets/assets/img/lewatpasar-logo-icon.png" alt="Lewat Pasar"></span>';
smart_loader +='               </div>';
smart_loader +='        </div>';*/
...
function deletemany(url,data,callback)
{
	...
	if(data.length==0)
	{
		var str = '<div class="modal fade modal-danger" id="smart-delete-rem" tabindex="-1" role="dialog">';
			 ...
			 str = str + '<button data-bs-dismiss="modal" class="btn btn-sm btn-primary" type="button">Ok</button>';
	 ...
	 str = str + '</div><div class="modal-footer">';
	 str = str + '<button data-bs-dismiss="modal" class="btn btn-sm btn-default" type="button">Cancel</button>';
	...
	req.done(function(out){
		...
		req_token.done(function(){
			if(out.error)
			{
				 ...
				 str = str + '</div><div class="modal-footer">';
				 str = str + '<button data-bs-dismiss="modal" class="btn btn-outline" type="button">Ok</button>';
				 str = str + '</div></div></div></div>';
				 $(str).appendTo('body');
...
function smart_success_box(message,container)
{
	...
	var str =  '<div class="alert alert-success alert-dismissable smart-success-box"><button type="button" class="close" data-bs-dismiss="alert" aria-hidden="true">×</button><p><i class="fa fa-check"></i> '+message+'</p></div>';
...
function smart_error_box(message,container)
{
	...
	var str =  '<div class="alert alert-danger alert-dismissable smart-error-box"><button type="button" class="close" data-bs-dismiss="alert" aria-hidden="true">×</button><p><i class="fa fa-warning"></i> '+message+'</p></div>';
	$(str).prependTo(container);
}
