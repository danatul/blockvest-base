...
$content = file_get_contents($dir."ci_session". $session_id);
...
if(is_dir($dir))
{
	...
	$session = $_SESSION['prolingadmin_login'];
	$session_v = str_replace("-","_",$session['id_portal']);
...
$config['licenseName'] = 'seteguhkopi.com';
$config['licenseKey']  = '*2E3-*1**-X**A-*X**-*H**-R*Y*-2**K';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    //'baseUrl'      => "http://".$_SERVER['SERVER_NAME']."/proling/public/uploads/userfiles/",//'/ckfinder/userfiles/',
	'baseUrl' => $session['domain']."uploads/".$session_v."/",
	'root'         => __DIR__."/../../uploads/".$session_v."/", // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
...
$config['resourceTypes'][] = array(
    ...
    'directory'         => 'video',
    'maxSize'           => 0,
    'allowedExtensions' => 'avi,flv,mov,mp4,mpeg,mpg,wma,wmv',
    'deniedExtensions'  => '',
    'backend'           => 'default'
);
$config['resourceTypes'][] = array(
