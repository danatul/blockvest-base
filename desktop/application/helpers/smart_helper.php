...
{
	$CI =& get_instance();
	$ses = $CI->session->userdata('blockvest_desktop');
...
function email_config()
{
	...
	*/
	$config = Array(
		'protocol' => 'smtp',		'validation' => true,		'wordwrap' => true,		'priority' =>3,
		'smtp_host' => 'ssl://smtp.googlemail.com',
		'smtp_port' => 465,
		'smtp_user' => 'sospawndev@gmail.com',//'hai@sospawn.xyz', 
		'smtp_pass' => 'KUN3XT4B8T87%', 
		'mailtype'  => 'html', 
		'newline' => "\r\n",
		'charset'   => 'iso-8859-1'
	);
...
{
	$CI =& get_instance();
	$ses = $CI->session->userdata('blockvest_desktop_lang');
	return $ses;
