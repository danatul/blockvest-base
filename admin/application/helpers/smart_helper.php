...
{
	$CI =& get_instance();
	$ses = $CI->session->userdata('adminblockvest_login');
...
function varpayment()
{
	$arr = array("Waiting","successful","Failed");
	return $arr;
}
...
{
	$CI =& get_instance();
	return $CI->db->where('status',0)->get('tasks')->num_rows();
} 
...
function wallet_partner()
{
	return "perubahan2024!0!";
} 