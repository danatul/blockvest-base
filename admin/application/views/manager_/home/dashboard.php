             ...
             <div class="col">
                <div class="card radius-10 bg-warning">
                  <div class="card-body text-center">
                    ...
                    <p class="mb-0 text-white">Transfer</p>
                    <h5 class="mt-4 mb-0 text-black"><?=number_format($tf_total['total'],0)?></h5>
               ...
               <div class="col">
                <div class="card radius-10 bg-success">
                  <div class="card-body text-center">
                    ...
                    <p class="mb-0 text-white">Withdraw</p>
                    <h5 class="mt-4 mb-0 text-black"><?=number_format($wd_total['total'],0)?></h5>
