...
function deletemany(url,data,callback)
{
	...
	if(data.length==0)
	{
		var str = '<div class="modal fade modal-danger" id="smart-delete-rem" tabindex="-1" role="dialog">';
			 ...
			 str = str + '<button data-dismiss="modal" data-bs-dismiss="modal" class="btn btn-sm btn-primary" type="button">Ok</button>';
	 ...
	 str = str + '</div><div class="modal-footer">';
	 str = str + '<button data-dismiss="modal" data-bs-dismiss="modal" class="btn btn-sm btn-default" type="button">Cancel</button>';
...
function smart_success_box(message,container)
{
	...
	var str =  '<div class="alert alert-success alert-dismissable smart-success-box"><button type="button" class="close" data-dismiss="alert" data-bs-dismiss="alert" aria-hidden="true">×</button><p><i class="fa fa-check"></i> '+message+'</p></div>';
...
function smart_error_box(message,container)
{
	...
	var str =  '<div class="alert alert-danger alert-dismissable smart-error-box"><button type="button" class="close" data-dismiss="alert" data-bs-dismiss="alert" aria-hidden="true">×</button><p><i class="fa fa-warning"></i> '+message+'</p></div>';
	$(str).prependTo(container);
}
